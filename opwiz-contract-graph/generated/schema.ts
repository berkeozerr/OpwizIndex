...
export class Option extends Entity {
  ...
  get indexOfColleteral(): BigInt | null {
    let value = this.get("indexOfColleteral");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
  ...
  set indexOfColleteral(value: BigInt | null) {
    if (!value) {
      this.unset("indexOfColleteral");
    } else {
      this.set("indexOfColleteral", Value.fromBigInt(<BigInt>value));
    }
  }

  get indexOfCounter(): BigInt | null {
    let value = this.get("indexOfCounter");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBigInt();
  ...
  set indexOfCounter(value: BigInt | null) {
    if (!value) {
      this.unset("indexOfCounter");
    } else {
      this.set("indexOfCounter", Value.fromBigInt(<BigInt>value));
    }
  }

  get indexOfPremium(): BigInt | null {
    let value = this.get("indexOfPremium");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBigInt();
  ...
  set indexOfPremium(value: BigInt | null) {
    if (!value) {
      this.unset("indexOfPremium");
    } else {
      this.set("indexOfPremium", Value.fromBigInt(<BigInt>value));
    }
  }
...
export class OptionDetail extends Entity {
  ...
  get indexOfListAsset(): BigInt | null {
    let value = this.get("indexOfListAsset");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBigInt();
  ...
  set indexOfListAsset(value: BigInt | null) {
    if (!value) {
      this.unset("indexOfListAsset");
    } else {
      this.set("indexOfListAsset", Value.fromBigInt(<BigInt>value));
    }
  }
  ...
  get colleteralType(): i32 {
    let value = this.get("colleteralType");
    return value!.toI32();
  }

  set colleteralType(value: i32) {
    this.set("colleteralType", Value.fromI32(value));
  }

  get counterAssetType(): i32 {
    let value = this.get("counterAssetType");
    return value!.toI32();
  }

  set counterAssetType(value: i32) {
    this.set("counterAssetType", Value.fromI32(value));
  }

  get listAssetType(): i32 {
    let value = this.get("listAssetType");
    return value!.toI32();
  }

  set listAssetType(value: i32) {
    this.set("listAssetType", Value.fromI32(value));
  }

  get premiumAssetType(): i32 {
    let value = this.get("premiumAssetType");
    return value!.toI32();
  }

  set premiumAssetType(value: i32) {
    this.set("premiumAssetType", Value.fromI32(value));
  }
